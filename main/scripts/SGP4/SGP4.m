...
classdef SGP4
  ...
  methods (Static)
    function dpper ( e3, ee2, peo, pgho, pho, pinco, plo, se2, se3, sgh2, sgh3, sgh4, sh2, sh3, si2, si3, sl2, sl3, sl4, t, xgh2, xgh3, xgh4, xh2, xh3, xi2, xi3, xl2, xl3, xl4, zmol, zmos,init, rec, opsmode)
        %/* --------------------- local variables ------------------------ */
        %alfdp, betdp, cosip, cosop, dalf, dbet, dls;
    ...
    function dsinit ( tc, xpidot, rec )
        ...
        %ainv2, aonv = 0.0, cosisq, eoc, f220, f221, f311;
    ...
    function dspace(tc, rec)
        %iretn;
        %delt, ft, theta, x2li, x2omi, xl, xldot, xnddt, xndt, xomi, g22, g32;
    ...
    function initl(epoch, rec)
        ...
        %ds70;
        %ts70, tfrac, c1, thgr70, fk5r, c1p2p;
        ...
        c1p2p = c1 + SGP4.twopi;
        gsto1 = SGP4.fmod(thgr70 + c1*ds70 + c1p2p*tfrac + ts70*ts70*fk5r, SGP4.twopi);
        if (gsto1 < 0.0)
            gsto1 = gsto1 + SGP4.twopi;
        end
        %    }
        %    else
    ...
    function ok= sgp4 (satrec, tsince, rvhand)
        
        %axnl, aynl, betal, cnod, cos2u, coseo1, cosi, cosip, cosisq, cossu, cosu;
            %delm, delomg, ecose, el2, eo1, esine, argpdf, pl, mrt ;
            %mvt, rdotl, rl, rvdot, rvdotl, sin2u, sineo1, sini, sinip, sinsu, sinu;
            %snod, su, t2, t3, t4, tem5, temp, temp1, temp2, tempa, tempe, templ, u, ux;
            %uy, uz, vx, vy, vz, xinc, xincp, xl, xlm, xmdf, xmx, xmy, nodedf, xnode, tc;
    ...
    function out = jday( year, mon, day, hr, minute, sec)
        jd = 0;
        jdFrac = 0;
